...
export default class extends Chart {
  ...
  render({
    ...
    upperWhiskerValue.enter()
      ...
      .attr('transform', d => `translate(${x(d.group) + x.bandwidth() - x.bandwidth() / 2 + 5}, ${y(d.upperWhisker)})`)
      .attr('text-anchor', 'start')
      .style('dominant-baseline', 'central')
      .style('opacity', 0)
    ...
    lowerWhiskerValue.enter()
      ...
      .attr('transform', d => `translate(${x(d.group) + x.bandwidth() - x.bandwidth() / 2 + 5}, ${y(d.lowerWhisker)})`)
      .attr('text-anchor', 'start')
      .style('dominant-baseline', 'central')
      .style('opacity', 0)
    ...
    upperQuartileValue.enter()
      ...
      .attr('transform', d => `translate(${x(d.group) - 5}, ${y(d.upperQuartile)})`)
    ...
    lowerQuartileValue.enter()
      ...
      .attr('transform', d => `translate(${x(d.group) - 5}, ${y(d.lowerQuartile)})`)
      .attr('text-anchor', 'end')
      .style('dominant-baseline', 'central')
      .style('opacity', 0)
    ...
    medianValue.enter()
      ...
      .merge(medianValue)
      .attr('transform', d => `translate(${x(d.group) + x.bandwidth() + 5}, ${y(d.median)})`)
      .attr('text-anchor', 'start')
      .style('dominant-baseline', 'central')
      .style('opacity', 0)
      .text(d => d.median);
